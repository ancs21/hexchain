...
class HexchainIOTClient {
  constructor(deviceId) {
    ...
    const privateKey = Secp256k1PrivateKey.fromHex(
      '1bb0520198e69ae15401111875eced6984951ecda9f0bed7ff2c3467a02c772e',
    )
  ...
  //   return fs.readFileSync(`../../deploy/.sawtooth/keys/${userprivkeyfile}`)
  // }

  // getUserPubKey(deviceId) {
  //   const userpubkeyfile = `${deviceId}.pub`
  //   return fs.readFileSync(`../../deploy/.sawtooth/keys/${userpubkeyfile}`)
  // }
